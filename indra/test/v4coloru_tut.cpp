...
namespace tut
{
	...
	void v4coloru_object::test<5>()
	{
		...
		ensure("1:set:Fail to set the values ", ((r == llcolor4u.mV[VX]) && (g == llcolor4u.mV[VY]) && (b == llcolor4u.mV[VZ])&& (a == llcolor4u.mV[VW])));

		llcolor4u.setToBlack();
		llcolor4u.set(r,g,b);
		ensure("2:set:Fail to set the values ", ((r == llcolor4u.mV[VX]) && (g == llcolor4u.mV[VY]) && (b == llcolor4u.mV[VZ])&& (255 == llcolor4u.mV[VW])));
		...
		llcolor4u2.set(vec);
		ensure("4:set:Fail to set the values ", ((vec[0] == llcolor4u2.mV[VX]) && (vec[1] == llcolor4u2.mV[VY]) && (vec[2] == llcolor4u2.mV[VZ])&& (vec[3] == llcolor4u2.mV[VW])));		
	}
	...
	void v4coloru_object::test<7>()
	{
		...
		ensure("lengthSquared:Fail ", is_approx_equal(llcolor4u.lengthSquared(), F32(r*r + g*g + b*b)));
		ensure("length:Fail ", is_approx_equal(llcolor4u.length(), F32(sqrt(F32(r*r) + F32(g*g) + F32(b*b)))));
	}
