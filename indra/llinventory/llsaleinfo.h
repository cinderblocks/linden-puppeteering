...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// Class LLInventorySaleInfo
//
// Derived from LLSaleInfo and overrides ::isForSale()
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

class LLInventorySaleInfo : public LLSaleInfo
{
public:
	LLInventorySaleInfo()
	:	LLSaleInfo()
	...
	LLInventorySaleInfo(EForSale sale_type, S32 sale_price)
	:	LLSaleInfo(sale_type, sale_price)
	{ }

	LLInventorySaleInfo(const LLSaleInfo& info)
	:	LLSaleInfo(info)
	{ }
	...
	{ 
		return LLSaleInfo::isForSale() 
				&& FS_CONTENTS != mSaleType;
	};
};
